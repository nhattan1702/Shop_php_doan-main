...
<header>
    <nav class="header">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="assets/img/logo.jpg" alt="logo" class="img_logo">
            </a>
        </div>
        ...
        <div class="menu">
            <ul class="ul_1">
                ...
                <li>
                    <a href="products.php?category=Xe">Xe <i class="fas fa-caret-down"></i></a>
                    <div class="sub_menu">
                        <?php
                ...
                <li>
                    <a href="products.php?category=Đồ đi phượt">Đồ đi phượt <i class="fas fa-caret-down"></i></a>
                    <div class="sub_menu">
                        <?php
