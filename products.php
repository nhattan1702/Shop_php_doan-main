...
<body>
    ...
    <div class="main_products">
        <div class="category">
            ...
            <div class="cate_item">
                <a href="products.php?category=Xe" class="cate">
                    <h5>Xe</h5>
                </a>
                <ul>
                    <?php
            ...
            <div class="cate_item">
                <a href="products.php?category=Đồ đi phượt" class="cate">
                    <h5>Đồ đi phượt</h5>
                </a>
                <ul>
                    <?php
        ...
        <div class="products">
            <div class="header_product">
                ...
                <div class="sort_product">
                    <div class="sort">
                        <p  class= "sorthover"style=" border: #1d3557 1px solid;display:block; width:130px ;text-align: center;">Sắp xếp<i class="fas fa-caret-down"></i> </p>
                    </div>
                    <div class="sub_menu">
                        <?php
                        if (isset($_GET['category'])) {
